package synergynet.table.apps.projectmanagement.component;
...
import synergynet.table.apps.projectmanagement.gesture.ScrollBarControl;
import synergynet.table.apps.projectmanagement.gesture.ScrollBarControl.ScrollBarListener;

import com.jme.scene.Spatial;

public class ScrollBar {

	private static final long serialVersionUID = 3700729074120099167L;
