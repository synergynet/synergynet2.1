package synergynet.table.apps.threeDButtonsExperiment.utils;
...
public class ConditionsReader {
	...
	public static String readConditions(List<String> pcConditions, List<String> mtConditions, List<String> mtViewConditions){
		...
		String fileName = "src_synergynet/synergynet/table/apps/threeDButtonsExperiment/conditionsConfig.txt";
	...
	public static String readConditions(List<String> experimentConditions){
		...
		String fileName = "src_synergynet/synergynet/table/apps/threeDManipulationExperiment/conditionsConfig.txt";
