package synergynet.table.apps.threedpuzzle.tetrisfactory;
...
import synergynet.table.apps.threedpuzzle.TetrisLoader.TetrisLoader;
import synergynet.table.apps.threedpuzzle.gestures.TwoFingersGesture;
	...
	private void buildTetris(int number){
		...
		for (int i=0; i<number;i++){
			for (String tetrisType:tetrisTypes){
				model = Resources.class.getClassLoader().getResource("data/threedmanipulation/"+tetrisType+".obj");
