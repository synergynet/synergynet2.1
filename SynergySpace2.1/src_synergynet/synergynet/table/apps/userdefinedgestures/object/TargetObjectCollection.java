package synergynet.table.apps.userdefinedgestures.object;
...
public class TargetObjectCollection {
	...
	public TargetObjectCollection(Node worldNode, DirectionalShadowMapPass pass){
    	...
    	"data/threedmanipulation/texture.jpg"),  Texture.MinificationFilter.Trilinear, Texture.MagnificationFilter.Bilinear);
