package synergynet.table.apps.threeDInteraction.desktop;
...
public class FloatDesktop {
    ...
    public FloatDesktop(String name, Vector3f location, int width, int height, Node worldNode){
    	...
    	texture  = TextureManager.loadTexture(Resources.getResource(
    	 "data/threedmanipulation/wallpaper.png"),  Texture.MinificationFilter.Trilinear, Texture.MagnificationFilter.Bilinear);
