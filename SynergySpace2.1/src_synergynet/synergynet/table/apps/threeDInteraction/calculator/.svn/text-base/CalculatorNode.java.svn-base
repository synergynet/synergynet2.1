...
public class CalculatorNode extends Node {
	...
	protected void init(){
		...
		ControllerBodyNode bn = new ControllerBodyNode("Body"+name, width/2, length/2, height/2, 0.1f, Resources.getResource("data/threedmanipulation/calculator/body.png"));	
		this.attachChild(bn);
		...
		final DisplayNode dn = new DisplayNode("Display"+name, width*0.9f/2, (float)(length*7/60), height*1.5f, 0.1f, Resources.getResource("data/threedmanipulation/calculator/body.png"));
		...
		//row 1
		ButtonNode buttonNode0 = new ButtonNode("0"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button0.png"));
		...
		ButtonNode buttonNodeDot = new ButtonNode("."+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttondot.png"));
		...
		ButtonNode buttonNodeResult = new ButtonNode("="+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttonresult.png"));
		...
		ButtonNode buttonNodeDivide = new ButtonNode("/"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttondivide.png"));
		...
		ButtonNode buttonNode1 = new ButtonNode("1"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button1.png"));
		...
		ButtonNode buttonNode2 = new ButtonNode("2"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button2.png"));
		...
		ButtonNode buttonNode3 = new ButtonNode("3"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button3.png"));
		...
		ButtonNode buttonNodeMultiply = new ButtonNode("*"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttonmultiply.png"));
		...
		ButtonNode buttonNode4 = new ButtonNode("4"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button4.png"));
		...
		ButtonNode buttonNode5 = new ButtonNode("5"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button5.png"));
		...
		ButtonNode buttonNode6 = new ButtonNode("6"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button6.png"));
		...
		ButtonNode buttonNodeSubstract = new ButtonNode("-"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttonsubstract.png"));
		...
		ButtonNode buttonNode7 = new ButtonNode("7"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button7.png"));
		...
		ButtonNode buttonNode8 = new ButtonNode("8"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button8.png"));
		...
		ButtonNode buttonNode9 = new ButtonNode("9"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/button9.png"));
		...
		ButtonNode buttonNodePlus = new ButtonNode("+"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, Resources.getResource("data/threedmanipulation/calculator/buttonBg.png"), Resources.getResource("data/threedmanipulation/calculator/buttonplus.png"));
