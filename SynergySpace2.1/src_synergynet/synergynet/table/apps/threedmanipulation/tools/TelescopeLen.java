...
import synergynet.table.apps.threedmanipulation.gestures.TelescopeFrameMoveZoom;
...
public class TelescopeLen extends Node{
	...
	public TelescopeLen(String name, ContentSystem contentSystem, float telescopeRadius, final CameraNode camNode, List<Spatial> manipulatableOjbects){
		...
		texture  = TextureManager.loadTexture(Resources.getResource(
		    	"data/threedmanipulation/telescope1.png"),  Texture.MinificationFilter.Trilinear, Texture.MagnificationFilter.Bilinear);
